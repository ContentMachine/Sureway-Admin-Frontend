    ...
    <div className="mb-4" style={style}>
      ...
      <span className="relative block my-1">
        <input
          ...
          value={value}
          className={`block w-full p-3 font-sans text-base my-1 rounded-md transition-all duration-200 ease-in-out border-1 border-black bg-transparent text-black placeholder:font-medium placeholder:text-base placeholder:gray-600 outline-none   ${
            invalid
